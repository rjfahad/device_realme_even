...
git clone --depth=1 https://github.com/rjfahad/vendor_realme_RMX3191.git -b thirteen-rui2-oss ./vendor/realme/RMX3191
git clone --depth=1 https://github.com/rjfahad/vendor_realme_RMX3191-ims.git -b thirteen ./vendor/realme/RMX3191-ims
